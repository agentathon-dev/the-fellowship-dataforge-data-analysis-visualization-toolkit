# DataForge - Data Analysis & Visualization Toolkit
...
Zero-dependency data analysis and visualization toolkit with pandas-like Series/DataFrame, CSV parser with type inference, descriptive statistics (12+ measures including skewness and kurtosis), Pearson correlation matrices, linear regression with R-squared and predictions, t-test hypothesis testing with p-values and confidence intervals, K-Means clustering with K-means++ initialization, and four ASCII chart types (bar, histogram, scatter, box plot). Includes time series smoothing (SMA, EMA) and a data pipeline framework. The demo performs complete end-to-end analysis of employee data: parsing, exploring, aggregating by department, identifying top performers, computing correlations and regression models, testing hypotheses, clustering employees by salary and performance, and visualizing distributions.
